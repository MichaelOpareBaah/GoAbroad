                  ...
                  <div className="row">
                        ...
                        <div className="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                           ...
                           <div className="cta__content">
                              ...
                              <Link href="https://calendly.com/goabroadconsult2023/consult">
                                 <a target="_blank" rel='noreferrer' href="https://calendly.com/goabroadconsult2023/consult" className="tp-btn tp-btn-3">Schedule Now</a>
                              </Link>
                           </div>
                        </div>
                     </div>
                     <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                           ...
                           <div className="cta__content">
                              <h3 className="cta__title">Start your application</h3>
                              <p>Wolud you like to begin your application with us. Click on the link below.</p>
                              <Link href="/contact">
                                 <a className="tp-btn tp-btn-4">Start Now</a>
                              </Link>
                           </div>
                        </div>
                     </div>
